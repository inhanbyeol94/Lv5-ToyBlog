...
class CommentService {
    ...
    findAllComment = async ({ postId }) => {
        ...
        const result = await this.commentRepository.findAllComment({ post_id: postId });
    ...
    createComment = async ({ postId, id, content }) => {
        ...
        const { comment_id } = await this.commentRepository.createComment({ post_id: postId, user_id: id, content: content });
    ...
    updateComment = async ({ postId, commentId, id, content }) => {
        ...
        const findComment = await this.commentRepository.findOneComment([{ post_id: postId }, { comment_id: commentId }]);
        ...
        await this.commentRepository.updateComment({ content: content, updated_at: new Date() }, [{ post_id: postId }, { comment_id: commentId }, { user_id: id }]);
    ...
    deleteComment = async ({ postId, commentId, id }) => {
        ...
        await this.commentRepository.deleteComment([{ post_id: postId }, { comment_id: commentId }, { user_id: id }]);
